      ...
      >
        <Grid container sx={{ width: "70%" }}>
          ...
          >
            ...
            <Typography variant="h6" sx={{ mr: "15px" }}>
              Is your camera on during meetings?
            </Typography>
          </Grid>
          <Grid
            item
          ...
          >
            ...
            <Tooltip
              placement="top-start"
              title="This can be found on old internet bills, and is the broadband infrastructure that allows you to connect to the web"
            >
              <Typography
                variant="h6"
                sx={{ ml: "15px", "&:hover": { cursor: "pointer" } }}
              >
                ?
              </Typography>
            </Tooltip>
