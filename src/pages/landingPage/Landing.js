    ...
    return (
        <div className="App">
            <Container sx={{height: '100%'}}>
                ...
                <div>
                    <Typography variant='subtitle1' sx={{mt: '6vh', mb: '4vh'}}>Calculate your carbon emissions today, to make tomorrow better!</Typography>      
                ...
                <div className='Helpertext'>
                    ...
                    <Typography variant='subtitle1'>The calculator will ask you questions about an average week at work, including where you work - in the office or at home, how far you travel to and from your office and by what mode, what broadband connection type and video conferencing platform you use when working from home and heating technology and time used when working from home. </Typography>
